...
public class Ride implements Serializable {
	...
	public Ride(Integer rideNumber, String from, String to, Date date, int nPlaces,float price, Driver driver, boolean asegurado) {
		super();
	...
	public Ride(String from, String to,  Date date, int nPlaces,float price, Driver driver,  boolean asegurado) {
		super();
		this.from = from;
		this.to = to;
		this.nPlaces = nPlaces;
