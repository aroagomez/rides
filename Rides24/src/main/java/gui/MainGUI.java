...
public class MainGUI extends JFrame {
	...
	public MainGUI(Driver d) {
		...
		jLabelSelectOption = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("Seleccionar opción"));
		...
		btnLogin = new JButton(ResourceBundle.getBundle("Etiquetas").getString("MainGUI.Login"));
		...
		btnErregistratu = new JButton(ResourceBundle.getBundle("Etiquetas").getString("MainGUI.Erregistratu"));
	...
	private void paintAgain() {
		...
		btnErregistratu.setText(ResourceBundle.getBundle("Etiquetas").getString("MainGUI.Erregistratu"));
